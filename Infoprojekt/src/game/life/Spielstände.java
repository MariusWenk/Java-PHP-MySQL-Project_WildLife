...
public class Spielstände extends BasicGameState  {
	...
	public void render(GameContainer container, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		g.drawString("Wähle den Spielstand, den du laden möchtest durch klicken auf die jeweilige Zeile", 100, 10);
		g.drawLine(20, 40, container.getWidth()-20, 40);
		g.drawString("SpielID    Anzahl Spieler    Wertungen    Gesamtentwicklung: Spieler  1    2    3    4   Plättcen auf Plan: Spieler  1    2    3    4    Punkte: Spieler  1    2    3    4", 20, 50);
